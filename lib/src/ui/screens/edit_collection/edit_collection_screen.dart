...
class EditCollectionScreen extends StatefulWidget {
  ...
  const EditCollectionScreen({super.key, this.collection});
...
class _EditCollectionScreenState extends State<EditCollectionScreen> {
  ...
  void initState() {
    ...
    if (widget.collection != null) {
      ...
      _image = File(widget.collection!.imagePath!);
      _isImageAdded = true;
    }
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Center(
          child: AppButton(
            onPressed: () {
              Navigator.pop(context); // Добавил возможность выхода
            },
        ...
        title: Text(
          widget.collection != null ? 'Edit Collection' : 'Create Collection', // Меняем заголовок
      ...
      floatingActionButton: AppButton(
        onPressed: () {
          ...
          context.read<CollectionBloc>().add(AddCollection(updatedCollection));
